...
if __name__ == '__main__':
    # 下载标签页
    tag = getBinaryHtml('http://movie.douban.com/tag/')
    addr = 'D:\workplace\pythonwork\douban_book_catch_zzq\database/movie_tag.html'
    if os.path.exists(addr):
        pass
    else:  # 否则新建
        print('新建：' + addr)
        os.makedirs(addr)
    file = open('D:\workplace\pythonwork\douban_book_catch_zzq\database/movie_tag.html', 'wb')  # 以写二进制的方式，写入获得的内容
    file.write(tag)
    file.close()

    # 下载某个Tag下的movie页
    content1 = getHtml("https://movie.douban.com/tag/%E7%88%B1%E6%83%85")
    addr1 = 'D:\workplace\pythonwork\douban_book_catch_zzq\database/movies.html'
    ...
    # 测试movie详情页
    content2 = getHtml("https://movie.douban.com/subject/25900945/")
    addr2 = 'D:\workplace\pythonwork\douban_book_catch_zzq\database/movie.html'
